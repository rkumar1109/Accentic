...
export default function Stats() {
  ...
  return (
    <section
      ref={ref}
      className="py-20 bg-gradient-to-br from-darkBlue to-indigo relative overflow-hidden"
    >
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-white/70 mb-12 leading-relaxed">
              Numbers that speak for themselves. Our commitment to excellence is
              reflected in every project we deliver.
            </p>
