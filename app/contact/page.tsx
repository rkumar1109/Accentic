...
export default function Contact() {
  ...
  const [web3FormsLoaded, setWeb3FormsLoaded] = useState(false);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setShowThankYou(true); // Show custom modal immediately
      } else {
  ...
  return (
    ...
    >
      ...
      <Footer />
      <WhatsAppFloat />
      {/* Custom Thank You Modal Fallback */}
      {showThankYou && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full text-center relative">
            ...
            <p className="text-[#2E2E2E]/80 mb-6">
              ...
              interest and will get back to you soon.
            </p>
            <button
              className="mt-2 px-6 py-2 bg-[#C38E70] text-white rounded-xl font-semibold hover:bg-[#a06b4e] transition"
      ...
      <Script
        ...
        onLoad={() => setWeb3FormsLoaded(true)}
      />
    </motion.div>
  );
}
